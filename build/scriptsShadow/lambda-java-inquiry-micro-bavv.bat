...
set CLASSPATH=%APP_HOME%\lib\lambda-java-inquiry-micro-bavv-1.0-all.jar

@rem Execute lambda-java-inquiry-micro-bavv
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LAMBDA_JAVA_INQUIRY_MICRO_BAVV_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%LAMBDA_JAVA_INQUIRY_MICRO_BAVV_EXIT_CONSOLE%" exit 1
exit /b 1
