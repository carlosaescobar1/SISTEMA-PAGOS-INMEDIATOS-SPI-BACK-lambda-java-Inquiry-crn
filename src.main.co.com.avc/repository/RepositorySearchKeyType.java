 ...
 */
@Slf4j
public class RepositorySearchKeyType {
     ...
     */
    public List<Hit<HashMap>> searchKeyType(OpenSearchClient client, InputRqKeyType inputRqKeyType) {
        ...
        try {
            searchResponse = client.searchTemplate(s -> s
                            ...
                            .id(ConstantsEnum.SEARCH_TEMPLATE_KEY_TYPE.getValue())
                            .params("custIdentType", JsonData.of(inputRqKeyType.getCustIdentType()))
                            .params("custIdentNum", JsonData.of(inputRqKeyType.getCustIdentNum()))
                            .params("bankId", JsonData.of(inputRqKeyType.getBankId()))
                            .params("keyType", JsonData.of(inputRqKeyType.getRefType()))
                    ,
                    HashMap.class);
