 ...
 */
@Slf4j
public class RepositorySearchAccount {
     ...
     */
    public List<Hit<HashMap>> searchKeyAccount(OpenSearchClient client, InputRqAccount inputRqAccount) {
        ...
        try {
            searchResponse = client.searchTemplate(s -> s
                            ...
                            .params("custIdentType", JsonData.of(inputRqAccount.getCustIdentType()))
                            .params("custIdentNum", JsonData.of(inputRqAccount.getCustIdentNum()))
                            .params("bankId", JsonData.of(inputRqAccount.getBankId()))
                            .params("acctType", JsonData.of(inputRqAccount.getReqBPostAccountRelationships()
                                    .getXferInfo()
                                    .getCardAcctIdFrom().getCardAcctId().getAcctType()))
                            .params("acctId", JsonData.of(inputRqAccount.getReqBPostAccountRelationships()
                                    .getXferInfo()
                                    .getCardAcctIdFrom().getCardAcctId().getAcctId()))
                    ,
                    HashMap.class);
