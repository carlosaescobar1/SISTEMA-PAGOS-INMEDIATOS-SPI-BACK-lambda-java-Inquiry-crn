 ...
 */
@Slf4j
public class RepositorySearchCust {
     ...
     */
    public List<Hit<HashMap>> searchKeyCust(OpenSearchClient client, InputRqCust inputRqCust, int querySize) {
        log.info("ENTRO AL searchKeyCust");
        ...
        try {
            searchResponse = client.searchTemplate(s -> s
                            ...
                            .id(ConstantsEnum.SEARCH_TEMPLATE_KEY_CUST.getValue())
                            .params("custIdentType", JsonData.of(inputRqCust.getCustIdentType()))
                            .params("custIdentNum", JsonData.of(inputRqCust.getCustIdentNum()))
                            .params("bankId", JsonData.of(inputRqCust.getBankId()))
                            .params("size", JsonData.of(querySize))
                    ,
                    HashMap.class);
