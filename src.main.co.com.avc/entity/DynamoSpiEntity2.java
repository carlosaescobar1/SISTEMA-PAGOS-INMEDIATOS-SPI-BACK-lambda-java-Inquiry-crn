...
@Introspected
@ReflectiveAccess
@SerdeImport(DynamoSpiEntity2.class)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
public class DynamoSpiEntity2 {
    ...
    public static final TableSchema<DynamoSpiEntity2> TABLE_SCHEMA_DYNAMO_SPI = TableSchema.builder(DynamoSpiEntity.class)
            .newItemSupplier(DynamoSpiEntity2::new)
            .addAttribute(
